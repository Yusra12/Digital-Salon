  <div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            ...
            <li>
             <a href="manage-services.php"><i class="fa fa-cogs nav_icon"></i>Manage Services </a>
        ...
        <!--   <li>
            ...
            <li>
              <a href="artist-list.php" class="chart-nav"><i class="fa fa-users nav_icon"></i>Artists List</a>
            </li>
              <li>
